-- Fix student portals table to avoid duplicate usernames
-- Add a check to see if portal already exists before creating

-- Add unique constraint on student_id to prevent duplicate portals per student
ALTER TABLE public.student_portals 
ADD CONSTRAINT student_portals_student_id_unique UNIQUE (student_id);

-- Create function to get or create student portal
